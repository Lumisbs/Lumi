...
<p align="center">
  [<a href="https://discord.gg/TgQ3Cu2F7A">Join Discord Server</a>] [<a href="https:///Lumi.sbs">Try it</a>] [<a href="https://github.com/Lumisbs/Lumi/blob/main/docs/README.zh-CN.md">简体中文</a>] [<a href="https://github.com/Lumisbs/Lumi/blob/main/docs/README.ja-JP.md">日本語</a>] [<a href="https://github.com/Lumisbs/Lumi/blob/main/docs/README.ru-RU.md">Русский</a>] [<a href="https://github.com/Lumisbs/Lumi/blob/main/docs/README.vi.md">Tiếng Việt</a>]
</p>
...
<p align="center">
  ...
  <a href="https://x.com/Lumisbs"><img src="https://img.shields.io/badge/%40proj__airi-black?style=flat&logo=x&labelColor=%23101419&color=%232d2e30"></a>
...
- [x] Brain
  ...
  - [x] Play [Factorio](https://www.factorio.com) (WIP, but [PoC and demo available](https://github.com/Lumisbs/Lumi-factorio))
...
### Stage Web (Browser Version at [Lumi.sbs](https://Lumi.sbs))
...
## Support of LLM API Providers (powered by [xsai](https://github.com/Lumisbs/xsai))
...
- [Awesome AI VTuber](https://github.com/): A curated list of AI VTubers and related projects
- [`unspeech`](https://github.com/Lumisbs/unspeech): Universal endpoint proxy server for `/audio/transcriptions` and `/audio/speech`, like LiteLLM but for any ASR and TTS
- [`hfup`](https://github.com/Lumisbs/hfup): tools to help on deploying, bundling to HuggingFace Spaces
- [`xsai-transformers`](https://github.com/Lumisbs/xsai-transformers): Experimental [🤗 Transformers.js](https://github.com/huggingface/transformers.js) provider for [xsAI](https://github.com/Lumisbs/xsai).
- [WebAI: Realtime Voice Chat](https://github.com/proj-airi/webai-realtime-voice-chat): Full example of implementing ChatGPT's realtime voice from scratch with VAD + STT + LLM + TTS.
- [`@Lumisbs/drizzle-duckdb-wasm`](https://github.com/Lumisbs/Lumi/tree/main/packages/drizzle-duckdb-wasm/README.md): Drizzle ORM driver for DuckDB WASM
- [`@Lumisbs/duckdb-wasm`](https://github.com/Lumisbs/Lumi/tree/main/packages/duckdb-wasm/README.md): Easy to use wrapper for `@duckdb/duckdb-wasm`
- [`tauri-plugin-mcp`](https://github.com/Lumisbs/Lumi/blob/main/crates/tauri-plugin-mcp/README.md): A Tauri plugin for interacting with MCP servers.
- [AIRI Factorio](https://github.com/Lumisbs/Lumi-factorio): Allow AIRI to play Factorio
- [Factorio RCON API](https://github.com/nekomeowww/factorio-rcon-api): RESTful API wrapper for Factorio headless server console
- [`autorio`](https://github.com/Lumisbs/Lumi-factorio/tree/main/packages/autorio): Factorio automation library
- [`tstl-plugin-reload-factorio-mod`](https://github.com/Lumisbs/Lumi-factorio/tree/main/packages/tstl-plugin-reload-factorio-mod): Reload Factorio mod when developing
- [Velin](https://github.com/luoling8192/velin): Use Vue SFC and Markdown to write easy to manage stateful prompts for LLM
- [`demodel`](https://github.com/Lumisbs/demodel): Easily boost the speed of pulling your models and datasets from various of inference runtimes.
- [`inventory`](https://github.com/Lumisbs/inventory): Centralized model catalog and default provider configurations backend service
- [MCP Launcher](https://github.com/Lumisbs/mcp-launcher): Easy to use MCP builder & launcher for all possible MCP servers, just like Ollama for models!
- [🥺 SAD](https://github.com/Lumisbs/sad): Documentation and notes for self-host and browser running LLMs.
...
flowchart TD
  Core("Core")
  Unspeech("unspeech")
  DBDriver("@Lumisbs/drizzle-duckdb-wasm")
  MemoryDriver("[WIP] Memory Alaya")
  DB1("@Lumisbs/duckdb-wasm")
  SVRT("@Lumisbs/server-runtime")
  Memory("Memory")
  STT("STT")
  Stage("Stage")
  ...
  subgraph UI_Components
    UI --> StageUI
    UITransitions("@Lumisbs/ui-transitions") --> StageUI
    UILoadingScreens("@Lumisbs/ui-loading-screens") --> StageUI
    FontCJK("@Lumisbs/font-cjkfonts-allseto") --> StageUI
    FontXiaolai("@Lumisbs/font-xiaolai") --> StageUI
  end

  subgraph Apps
    Stage --> StageWeb("@Lumisbs/stage-web")
    Stage --> StageTamagotchi("@Lumisbs/stage-tamagotchi")
    Core --> RealtimeAudio("@Lumisbs/realtime-audio")
    Core --> PromptEngineering("@Lumisbs/playground-prompt-engineering")
  end

  subgraph Server_Components
    Core --> ServerSDK("@Lumisbs/server-sdk")
    ServerShared("@Lumisbs/server-shared") --> SVRT
  ...
  Core --> TauriMCP("@Lumisbs/tauri-plugin-mcp")
...
- [`xsai`](https://github.com/Lumisbs/xsai): Implemented a decent amount of packages to interact with LLMs and models, like [Vercel AI SDK](https://sdk.vercel.ai/) but way small.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=Lumisbs/Lumi&type=Date)](https://www.star-history.com/#Lumisbs/Lumi&Date)
